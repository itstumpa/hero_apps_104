...
const [originalInstalledApps, setOriginalInstalledApps] = useState([]);
  ...
  // installed apps from localStorage
//   useEffect(() => {
...
const handleSort = (order) => {
  ...
  return (
    <div className="py-22 px-6 md:px-12 max-w-[1600px] mx-auto">
                ...
                <div className="flex justify-between items-center text-center gap-6">
                  <div className="flex gap-5">
                    ...
                    <div className="mt-1">
                      ...
                      <div className="flex flex-row text-sm text-green-700 mt-1 gap-3">
                        <h3 className="text-lg font-semibold gap-1 text-center items-center text-green-500 flex">
                          <Download className="w-5 text-green-500" />
                          {app.downloads}
                        </h3>
                        <h3 className="text-lg font-semibold gap-1 text-center items-center text-amber-500 flex">
                          <Star className="w-5" />
                          {app.ratingAvg}
                        </h3>
                        <h3 className="text-lg font-semibold">{app.size}</h3>
                      </div>
                    </div>
                  </div>
